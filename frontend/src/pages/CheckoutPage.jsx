    ...
    <>
      <nav className="navbar simple">
        <div className="nav-container">
          ...
          <a href="#" className="return-link" onClick={e=>{e.preventDefault();navigate("cart");}}>← Return to Cart</a>
        </div>
      </nav>
        ...
        <div className="container">
          <div className="checkout-layout">
              ...
              <section className="form-section">
                ...
                <form id="checkoutForm" ref={formRef}>
                  <div className="form-row">
                    <div className="form-group"><label>FIRST NAME</label><input type="text" defaultValue="John" required /></div>
                    <div className="form-group"><label>LAST NAME</label><input type="text" defaultValue="Doe" required /></div>
                  </div>
                  <div className="form-group"><label>STREET ADDRESS</label><input type="text" defaultValue="123 Fashion Ave, Apt 4B" required /></div>
                  <div className="form-row">
                    <div className="form-group"><label>CITY</label><input type="text" defaultValue="New York" required /></div>
                    <div className="form-group">
                      <label>STATE</label>
                      <select required defaultValue="NY">
                    ...
                    <div className="form-group"><label>ZIP CODE</label><input type="text" defaultValue="10001" required /></div>
                  </div>
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <div className="input-with-icon">
                        ...
                        <input type="tel" defaultValue="+1 (555) 000-0000" required />
                      </div>
                    </div>
                    <div className="form-group">
            ...
            <aside className="order-summary-checkout">
              ...
              <p className="items-count">{CHECKOUT_ITEMS.length} ITEMS</p>
